...
(function (global) {
  ...
  var STRINGS = {
    uk: {
      ...
      "form.phone_required": "Введіть номер телефону.",
      "form.too_many": "Забагато заявок. Спробуйте пізніше або зателефонуйте нам.",
      "form.session_expired": "Сесія застаріла. Оновіть сторінку і спробуйте ще раз.",
    ...
    ru: {
      ...
      "form.phone_required": "Введите номер телефона.",
      "form.too_many": "Слишком много заявок. Попробуйте позже или позвоните нам.",
      "form.session_expired": "Сессия устарела. Обновите страницу и попробуйте ещё раз.",
    ...
    en: {
      ...
      "form.phone_required": "Enter a phone number.",
      "form.too_many": "Too many requests. Try again later or give us a call.",
      "form.session_expired": "Your session has expired. Reload the page and try again.",
