...
(function (global) {
  ...
  var STRINGS = {
    uk: {
      ...
      "quote.min_note": "Спрацював мінімум для рейсів від {from} км — {min} грн",
    ...
    ru: {
      ...
      "quote.min_note": "Сработал минимум для рейсов от {from} км — {min} грн",
    ...
    en: {
      ...
      "quote.min_note": "Minimum for trips over {from} km applied — {min} UAH",
