...
(function (global) {
  ...
  var STRINGS = {
    uk: {
      ...
      "quote.local_note": "Мінімум {hours} год + подача {feed} грн. Підсумок назвемо в розмові.",
      "quote.local_cta": "Порахувати за годинами",
      "price.feed": "Виїзд",
      "form.bad_phone": "Введіть коректний номер телефону.",
      "form.country": "Код країни",
      "form.country_search": "Пошук країни",
      "form.country_top": "Популярні",
      "form.country_all": "Усі країни",
      "form.country_none": "Нічого не знайшли",
      "form.country_other": "Інша країна",
    ...
    ru: {
      ...
      "quote.local_note": "Минимум {hours} ч + подача {feed} грн. Итог назовём в разговоре.",
      "quote.local_cta": "Посчитать по часам",
      "price.feed": "Подача",
      "form.bad_phone": "Введите корректный номер телефона.",
    ...
    en: {
      ...
      "quote.local_note": "Minimum {hours} h plus a {feed} UAH call-out fee. We name the total on the call.",
      "quote.local_cta": "Switch to hourly",
      "price.feed": "Callout",
      "form.bad_phone": "Enter a valid phone number.",
