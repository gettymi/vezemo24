...
SOURCES = {
    ...
    # Вантажний відсік зсередини. Це кадр із zad.png — того самого фото, що
    # на сторінці транспорту, обрізаного в горизонт під картку. Ширше за 720
    # не робимо: у джерела саме стільки, а домальовувати пікселі, яких немає,
    # означає видати мило за різкість.
